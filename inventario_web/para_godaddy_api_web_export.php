<?php
/**
 * COPIAR ESTE ARCHIVO A GODADDY como: api/api_web_export.php
 *
 * Devuelve el inventario (tabla temp o web) en JSON para que Motus lo descargue por cron.
 * En GoDaddy usa la misma BD que api_web.php (automarketdev, etc.).
 */
...
// Exportar desde la tabla temporal (después del envío de Python) o la principal
