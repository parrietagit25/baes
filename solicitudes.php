...
<body>
                                ...
                                <table id="solicitudesTable" class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php endif; ?>
                                            <td><?php echo htmlspecialchars(solicitud_texto_vehiculo_lista($solicitud)); ?></td>
                                            <td>
                                                <?php if ($isAdmin): ?>
                                                    <?php 
    ...
    <!-- Modal texto extraído (OCR) -->
    <div class="modal fade" id="modalTextoExtraido" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTextoExtraidoTitulo">
                        <i class="fas fa-file-alt me-2"></i>Texto extraído del documento
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body" id="modalTextoExtraidoContenido"></div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                </div>
            </div>
