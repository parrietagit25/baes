...
$paginasAdmin = ['dashboard.php', 'usuarios.php', 'roles.php', 'bancos.php', 'ejecutivos_ventas.php', 'solicitudes.php', 'sol_financiamiento.php', 'seguimiento_financiamiento.php', 'subir_reporte_reservas.php', 'pipedrive.php', 'configuracion.php', 'reportes.php', 'encuestas_resultados.php'];
$paginasGestor = ['dashboard.php', 'solicitudes.php', 'sol_financiamiento.php', 'seguimiento_financiamiento.php', 'subir_reporte_reservas.php', 'usuarios_banco.php', 'ejecutivos_ventas.php'];
