...
<div class="col-md-3 col-lg-2 px-0 sidebar">
    ...
    <nav class="nav flex-column">
        ...
        <a class="nav-link ps-4 py-1 small <?php echo ($report_submenu === 'sucursales') ? 'active' : ''; ?>" href="reportes.php?submenu=sucursales">
        ...
        <a class="nav-link ps-4 py-1 small <?php echo ($report_submenu === 'encuestas') ? 'active' : ''; ?>" href="reportes.php?submenu=encuestas">
        ...
        <a class="nav-link ps-4 py-1 small <?php echo ($report_submenu === 'vehiculos') ? 'active' : ''; ?>" href="reportes.php?submenu=vehiculos">
