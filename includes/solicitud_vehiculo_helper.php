 ...
 */
function solicitud_sql_campos_vehiculo_reserva(): string
{
    return "
        ...
        (SELECT COUNT(*) FROM reportes_reservas_lineas r WHERE r.solicitud_id = s.id AND r.estado = 'aplicado') AS tiene_reserva_aplicada
    ";
}
