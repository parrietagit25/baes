<?php
/**
 * Correo al usuario banco cuando el gestor/admin selecciona su propuesta.
...
$content = '
    <h2>Propuesta seleccionada</h2>
    <p>Estimado/a <strong>' . $h($banco_nombre) . '</strong>,</p>

    <p>El gestor <strong>' . $h($gestorTxt) . '</strong> ha <strong>aceptado / seleccionado</strong> su propuesta para la siguiente solicitud de crédito.</p>
    ...
    <div class="info-box">
        <p><strong>Propuesta seleccionada</strong></p>
    ...
    <p>Puede revisar el detalle en MOTUS.</p>
